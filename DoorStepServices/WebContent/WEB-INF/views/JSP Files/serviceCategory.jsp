						...
						<div class="col-sm-8">
							...
							<form method="POST" class="form-horizontal">
								...
								<div class="form-group">
									<label class="control-label col-sm-2" for="cityName">Enter
										Service Category:</label>
									<div class="col-sm-8">
										<input type="text" name="serviceCategoryName"
											class="form-control" placeholder="Category Name" /><br>
									</div>
								</div>
								<div class="form-group">
									<div class="col-sm-12 ">
									...
									<tr>
										...
										<%-- <td>
											<form action="delete-service-category" method="post">
												<input type="hidden" name="categoryId" value="${service.serviceCategoryId}"/>
