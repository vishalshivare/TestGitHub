	...
	<div class="container-fluid bg-3 text-center">
		...
		<div class="col-sm-8">
			<div class="row">
				...
				<br>
				<h5>${sessionScope.updateSuccess }</h5>
				<form action="editUser" modelAttribute="editUser" method="post"
					name="myform" id="myform" class="form-horizontal">
					<div class="form-group">
						<label class="control-label col-sm-2" for="FirstName">First
							Name:</label>
						<div class="col-sm-10">
							<input type="text" name="firstName" class="form-control" value="${sessionScope.loggedInUser.firstName }"></input><br>
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-2" for="lastName">Last
							Name:</label>
						<div class="col-sm-10">
							<input type="text" name="lastName" class="form-control" value="${sessionScope.loggedInUser.lastName }"/><br>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<label class="control-label col-sm-2" for="Password">Mobile
							Number:</label>
						<div class="col-sm-10">
							<input type="text" name="mobileNumber" class="form-control" value="${sessionScope.loggedInUser.mobileNumber }"/><br>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="pinCode" class="form-control" value="${sessionScope.loggedInUser.pinCode }"/><br>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<label class="control-label col-sm-2" for="SecurityAnswer">Security
							Answer:</label>
						<div class="col-sm-10">
							<input type="text" name="securityAnswer" class="form-control" value="${sessionScope.loggedInUser.securityAnswer }"/><br>
						</div>
					</div>
					<div class="form-group">
						<div class="col-sm-12 ">
