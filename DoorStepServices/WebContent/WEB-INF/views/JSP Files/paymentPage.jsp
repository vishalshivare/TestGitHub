			...
			<form action="payment" method="post" class="form-horizontal">
				<table class="table table-bordered">
					<tbody>
						...
						<tr>
							<td>Booking Id</td>
							<td>${sessionScope.booking.bookingId }</td>
						</tr>
						<tr>
							<td>Address</td>
							<td>${sessionScope.booking.address }</td>
						</tr>
						<tr>
							<td>Date</td>
							<td>${sessionScope.booking.date }</td>
						</tr>
						<tr>
							<td>Time</td>
							<td>${sessionScope.booking.timeSlot }</td>
						</tr>
						<tr>
							<td>Total Bill</td>
							<td>${sessionScope.booking.bill }(Note:PayRs50 now and pay
								the rest to the serviceman after the service is completed)</td>
						</tr>
