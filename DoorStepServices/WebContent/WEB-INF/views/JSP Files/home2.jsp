		...
		<div class="collapse navbar-collapse" id="myNavbar">
			<ul class="nav navbar-nav navbar-right">
				...
				<li class="dropdown"><a class="dropdown-toggle"
					data-toggle="dropdown" href="#">Hi,
						${sessionScope.loggedInUser.firstName} <span class="caret"></span>
				</a>
	...
	<div id="myCarousel" class="carousel slide" data-ride="carousel">
		...
		<div class="carousel-inner" role="listbox">
			<div class="item active">
				<img
					src="http://jonathanrbaker.com/wp-content/uploads/2015/07/Plumbing.jpg"
			...
			<div class="item">
				<img
					src="http://www.panzieriplumbingandheating.com/images/background/bg01.jpg"
		...
		<div class="row">
			...
			<div class="col-sm-6">
				...
				<br> <a href="#demo2" data-toggle="collapse"> <img
					src="http://www.expressdrainandplumbing.com/images/bg02.jpg"
					class="img-circle person" alt="Random Name" width="255"
					height="255">
				</a>
				...
				<form action="booking">
					<div class="col-sm-4">
						<div class="thumbnail">
							...
							<input type="submit" class="btn" value="Plumber"
