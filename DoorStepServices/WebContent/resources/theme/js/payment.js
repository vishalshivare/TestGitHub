      ...
      $form.get(0).submit();
        ...
        $(document).ready(function() {
            ...
            function formResult(data) {
                $('.paypalResult').show().html('<br><div class="alert alert-success">Success: if you are not redirected, hit the PayPal button.</div><meta http-equiv="refresh" content="2; url=https://paypal.ca">');
