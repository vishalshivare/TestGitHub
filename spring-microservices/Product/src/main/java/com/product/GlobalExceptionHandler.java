...
public class GlobalExceptionHandler {
	...
	@ResponseStatus(value = HttpStatus.NOT_FOUND, reason = "The product does not exists in the system")
	@ExceptionHandler
	public void handleProductNotFoundException(ProductNotFoundException exception) {
